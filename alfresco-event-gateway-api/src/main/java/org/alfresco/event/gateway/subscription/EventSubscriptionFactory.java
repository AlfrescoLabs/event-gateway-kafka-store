 ...
 * using a {@link Subscription} object.
 */
@FunctionalInterface
public interface EventSubscriptionFactory {

    /**
     * Obtain an instance of {@link EventSubscription} given the requested subscription requirements.
     *
     * @param subscription given {@link Subscription} specification
     * @return the corresponding {@link EventSubscription} object
     */
