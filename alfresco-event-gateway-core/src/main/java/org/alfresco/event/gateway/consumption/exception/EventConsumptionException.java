...
/**
 * {@link RuntimeException} that reflects a problem consuming an event.
 */
public class EventConsumptionException extends RuntimeException {

    /**
     * Construct a new event consumption exception with the specified message and cause.
     *
     * @param message given message to add to the exception
     * @param cause   given {@link Throwable} that caused this exception
     */
    public EventConsumptionException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
